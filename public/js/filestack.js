...
! function() {
    ...
    if (window.filepicker)
        ...
        var l = function(e, t) {
                ...
                c.name = o.window.WINDOW_NAME, c.id = o.window.WINDOW_NAME, c.style.width = "100%", c.style.height = "100%", c.style.border = "none", c.style.position = "relative", c.setAttribute("border", 0), c.setAttribute("frameborder", 0), c.setAttribute("frameBorder", 0), c.setAttribute("marginwidth", 0), c.setAttribute("marginheight", 0), c.src = e, a.appendChild(c), i.appendChild(s), i.appendChild(a), document.body.appendChild(i);
                var l = n();
        ...
        var e = this,
            ...
            a = function(t, r) {
                ...
                var o = r.method ? r.method.toUpperCase() : "POST",
                    ...
                    a = r.error || function() {},
                    s = r.data || {};
                if ("http:" == window.location.protocol ? t = t.replace("https:", "http:") : "https:" == window.location.protocol && (t = t.replace("http:", "https:")),
                    r.async) throw new e.FilepickerException("Asyncronous Cross-domain requests are not supported");
        ...
        function e() {
            try {
                var e = 'btn btn-default btn-def btn-block',
                    t = document.head || document.getElementsByTagName("head")[0],
                    r = document.createElement("style");
                r.type = "text/css", r.styleSheet ? r.styleSheet.cssText = e : r.appendChild(document.createTextNode(e)), t.appendChild(r)
            } catch (n) {}
        ...
        var t = this,
            ...
            c = function(e) {
                ...
                r.setAttribute("type", "button"), r.innerHTML = e.getAttribute("data-fp-button-text") || "<i class='fa fa-camera' aria-hidden='true'></i> Update profile picture", r.className = e.getAttribute("data-fp-button-class") || e.className || "btn btn-default btn-def btn-block", e.style.display = "none";
                var o = a(e);
            ...
            l = function(e) {
                ...
                o.setAttribute("type", "button"), o.innerHTML = e.getAttribute("data-fp-button-text") || "Convert File", o.className = e.getAttribute("data-fp-button-class") || e.className || "btn btn-default btn-def btn-block", e.style.display = "none";
                var i = a(e, "convert");
                o.onclick = function() {
            ...
            u = function(e) {
                ...
                var o = document.createElement("button");
                o.setAttribute("type", "button"), o.innerHTML = e.getAttribute("data-fp-button-text") || "<i class='fa fa-camera' aria-hidden='true'></i> Update profile picture", o.className = e.getAttribute("data-fp-button-class") || "btn btn-default btn-def btn-block", r.appendChild(o);
            ...
            f = function(e, r, o, i) {
                ...
                t.dragdrop.makeDropPane(e, {
                    ...
                    dragEnter: function() {
                        e.innerHTML = "Drop to upload",
                            e.style.backgroundColor = "#E0E0E0", e.style.border = "1px solid #000"
                    },
                    dragLeave: function() {
